...
class reclamacioForm(ModelForm):
	...
	def __init__(self,team, *args, **kwargs):
		...
		self.fields['partida'] = forms.ModelChoiceField(Partida.objects.filter(equips=team, codi=not 0, acabada=True),to_field_name='id')
...
class reclamacioResposta(ModelForm):
	...
	def save(self):
		reclamacio = super(reclamacioResposta, self).save(commit=False)
